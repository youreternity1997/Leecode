# https://leetcode.com/problems/design-add-and-search-words-data-structure/solutions/4701869/61-1-approach-1-o-n-python-c-step-by-step-explanation/
# Time complexity: O(M) time, where M is the length of the word.
